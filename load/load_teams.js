...
let script = async () => {
  ...
  let allTeamData = await axios.all(req);
  allTeamData.map((res) => teams = [].concat(teams, res.data.hits.hits.map((t) => t._source)));
